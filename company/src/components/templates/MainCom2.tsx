  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center md:justify-start z-10">
        ...
        >
          <h1 className="text-white text-4xl md:text-6xl font-bold">개방</h1>
          <h1 className="text-white text-4xl md:text-6xl font-bold">융합</h1>
          <h1 className="text-white text-4xl md:text-6xl font-bold">창의성</h1>
